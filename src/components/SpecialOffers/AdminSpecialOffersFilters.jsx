// src/components/specialOffers/AdminSpecialOffersFilters.jsx
import React from 'react';
import { RiFilterLine, RiSearchLine, RiCloseLine } from 'react-icons/ri';
import './css/SpecialOffersFilters.css';

const AdminSpecialOffersFilters = ({ filters, updateFilters, resetFilters, t }) => {
  const hasActiveFilters = filters.status || filters.type || filters.channel || filters.search || filters.restaurant;

  return (
    <div className="offers-filters admin-offers-filters">
      {/* Search */}
      ...
      <div className="offers-filter-select">
        ...
        >
          <option value="">{t('specialOffers.filters.allRestaurants', 'Tous les restaurants')}</option>
...
export default AdminSpecialOffersFilters;