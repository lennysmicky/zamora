// src/components/specialOffers/AdminSpecialOffersStats.jsx
...
const AdminSpecialOffersStats = ({ stats, formatAmount, t }) => {
  return (
    <div className="offers-stats admin-offers-stats">
      ...
      <div className="offers-stat-card">
        <div className="offers-stat-icon scheduled">
          <RiTimeLine />
        </div>
        <div className="offers-stat-content">
          <span className="offers-stat-value">{stats.scheduledOffers || 0}</span>
          <span className="offers-stat-label">{t('specialOffers.stats.scheduled', 'Planifiées')}</span>
        </div>
      </div>
      <div className="offers-stat-card">
      ...
      <div className="offers-stat-card">
        <div className="offers-stat-icon store">
          <RiStore2Line />
        </div>
        <div className="offers-stat-content">
          <span className="offers-stat-value">{stats.restaurantsCount || 0}</span>
          <span className="offers-stat-label">{t('specialOffers.stats.restaurants', 'Restaurants')}</span>
        </div>
      </div>
    </div>
  );
...
export default AdminSpecialOffersStats;